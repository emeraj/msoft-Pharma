...
/* Added missing icon imports (ReceiptIcon, CashIcon, ChartBarIcon) to fix errors */
...
interface BillingProps {
  ...
  user?: User | null; // Added current user for counter tagging
    ...
    <div className="p-4 sm:p-6 space-y-6">
          ...
          <Card title={
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <input ref={searchInputRef} type="text" placeholder={isPharmaMode ? t.billing.searchPlaceholderPharma : t.billing.searchPlaceholderRetail} value={searchTerm} onChange={e => { setSearchTerm(e.target.value); setActiveIndices({ product: 0, batch: 0 }); }} onKeyDown={handleSearchKeyDown} className={`${inputStyle} w-full p-4 text-lg shadow-inner h-14`} autoFocus />
                <SearchIcon className="absolute right-4 top-4 h-6 w-6 text-slate-400" />
      ...
      {scanResultFeedback && (
          <div className="fixed bottom-10 left-1/2 -translate-x-1/2 bg-slate-900 text-white px-6 py-4 rounded-2xl shadow-2xl z-[60] flex items-center gap-4 animate-bounce border-2 border-indigo-500">
              ...
              <div>
                  <p className="text-[10px] font-black uppercase tracking-widest text-indigo-400">Added via AI Scan</p>
