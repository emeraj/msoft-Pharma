...
export const EmbeddedScanner: React.FC<ScannerProps> = ({ onScanSuccess, onClose }) => {
    ...
    const startScanner = async () => {
        ...
        try {
            ...
            const config = { 
                ...
                useBarCodeDetectorIfSupported: true, // Use native hardware/OS scanner if available (Much faster/accurate)
                formatsToSupport: [
            ...
            try {
                ...
                const constraints = { 
                    ...
                    advanced: [{ focusMode: "continuous" }] // Explicitly request continuous autofocus
                };
                ...
                // Handle specific error: "The play() request was interrupted..."
  ...
  }, [readerId]); // Removed isFullScreen/onScanSuccess dependencies to prevent restarts
  ...
  return (
    <div className={`relative ${isFullScreen ? 'fixed inset-0 z-[100] w-screen h-screen bg-black' : 'w-full h-64 rounded-xl mb-4'} overflow-hidden bg-black border border-slate-700 shadow-sm group transition-all duration-300`}>
        ...
        <div className="absolute inset-0 pointer-events-none flex items-center justify-center z-10">
            {/* Scanning Area Visuals - Purely decorative now as actual qrbox is dynamic */}
