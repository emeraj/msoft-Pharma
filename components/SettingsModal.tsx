    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Shop Profile">
      <div className="space-y-6">
        ...
        <div className="border-t dark:border-slate-700 pt-4">
          <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-3">Data Management</h4>
          <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
            Download a complete backup of all your application data (products, sales, purchases, etc.) as a single JSON file to your local drive.
          </p>
          <button
